...
AES.h
    这是应用程序的主头文件。
    其中包括其他项目特定的标头（包括 Resource.h），并声明 CAESApp 应用程序类。

AES.cpp
    这是包含应用程序类 CAESApp 的主应用程序源文件。
...
AESDlg.h、AESDlg.cpp - 对话框
    这些文件包含 CAESDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 AES.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
